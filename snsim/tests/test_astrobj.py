...
class TestSNIa:
    ...
    def test_genflux(self):
        ...
        print(lcs)
        test = {
            "flux": np.array([11362.46468601, 20694.48688965, 11352.90808572, 3578.52509832]),
            "fluxerr": np.array([106.59486238, 143.85578504, 106.55002621, 59.82077481]),
            "fluxtrue": np.array([11278.10909259, 20893.74397037, 11327.17449755, 3648.53840526]),
            "fluxerrtrue": np.array([106.19844204, 144.5466844, 106.42919946, 60.40313241]),
        }
