...
If you want to use subfield index for observation properties or just set the geomtry of the field, you have to give a .dat file that give the representation of the subfield, for example if you split your field into a 4 x 4 grid, you have to put something like that in your .dat file :
...
ID13:ID14:ID15:ID16
 ```
In the previous example the symbol # is used as a ra space of 0.13 degrees and the @ is used as a dec space of 0.13 degrees.
