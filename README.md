...
data :                                 
    ...
    band_dic: {'r':'ztfr','g':'ztfg','i':'ztfi'} #(Optional -> if bandname in db/obs file doesn't correpond to those in sncosmo registery)                   
    band_cfg: [('band_name1', '/PATH/TO/BAND/FILE1'), ...] #(Optional if you want to use your own bandpass -> compatible with band_dic)                   
